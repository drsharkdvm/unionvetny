...
export function SiteFooter() {
  return (
    <footer className="relative mt-auto bg-navy text-white/75">
      ...
      <div className="container-x relative py-16">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <div>
            ...
            <p className="mt-4 max-w-xs text-xs leading-relaxed text-white/55">
            ...
            <ul className="mt-5 space-y-3 text-sm">
              {NAV.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="inline-flex items-center gap-2 text-white/70 transition-colors hover:text-blue-100"
                  >
          ...
          <nav aria-label="Quick actions">
            ...
            <ul className="mt-5 space-y-3 text-sm">
              ...
              <li>
                <a href={ACTIONS.pharmacy.href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white/70 transition-colors hover:text-blue-100">
                  <Icon name="Pill" className="size-4 text-red" /> Online Pharmacy
                </a>
              </li>
              <li>
                <Link href="/our-services" className="inline-flex items-center gap-2 text-white/70 transition-colors hover:text-blue-100">
                  <Icon name="Stethoscope" className="size-4 text-red" /> Our Services
                </Link>
              </li>
              <li>
                <Link href="/faqs" className="inline-flex items-center gap-2 text-white/70 transition-colors hover:text-blue-100">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-4 text-sm">
              <li className="flex gap-3">
                ...
                <a href={SITE.address.maps} target="_blank" rel="noopener noreferrer" className="text-white/70 transition-colors hover:text-blue-100">
                  {SITE.address.street}
                  <br />
              ...
              <li className="flex gap-3">
                ...
                <a href={SITE.phone.href} className="text-white/70 transition-colors hover:text-blue-100">
                  {SITE.phone.display}
                </a>
              </li>
              <li className="flex gap-3">
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-7 text-xs text-white/55 sm:flex-row">
